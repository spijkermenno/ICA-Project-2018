<div class="registratie-container card p-3">
    <div class="card-body text-white">
        <h2>Registreer nu!</h2>
        <h5>Het registratieproces bestaat uit een aantal eenvoudige stappen:</h5>
        <ul>
            <li>1. Vul uw e-mailadres in</li>
            <li>2. Bevestig uw e-mailadres</li>
