...
@section('content')
    ...
    <form class="w-100 bg-dark px-2 py-5 mb-5 mt-0 mx-auto auction-form-wrapper rounded-bottom" method="post" action="{{ route('auction.add.check') }}" enctype="multipart/form-data">
